...
/* Created on:     13/11/2021 16:37:29                          */
/*==============================================================*/
...
create table EXAMENES (
   ...
   EXAMEN_SANGRE_EXAM   CHAR(150)            not null,
   EXAMEN_ORINA_EXAM    CHAR(150)            not null,
   EXAMEN_ECOGRAFIA_EXAM CHAR(150)            not null,
   EXAMEN_HECES_EXAM    CHAR(150)            not null,
